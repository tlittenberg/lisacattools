...
sed -i 's/ table/ pytable/g; s/your-github-id-here/tlittenberg/g; s/doc_url:/doc_url: https:\/\/tlittenberg.github.io\/lisacattools\/html\/index.html/g; s/license_file:/license_file: LICENSE/g' $CONDA/$name/meta.yaml
