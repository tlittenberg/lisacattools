...
from lisacattools import convert_ecliptic_to_galactic, confidence_ellipse
from lisacattools.utils import HPbin, HPhist
...
catPath = '/Users/tlittenb/lisacattools/tutorial/data/ucb'
...
err_circle_search = hp.query_disc(nside, centroid, np.deg2rad(rad_deg)*scale) # large circle for filtering point estimates
err_circle_select = hp.query_disc(nside, centroid, np.deg2rad(rad_deg)) # target circle for selecting samples
...
targets_df_cut[['Pmatch','SNR','Frequency','Frequency Derivative','cosinc']]
